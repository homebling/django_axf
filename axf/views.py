...
def home(request):
    ...
    return render(request, 'axf/home.html', {"title": "主页", "wheelsList": wheelsList, "navList": navList,
                                             "mustbuyList": mustbuyList, "shop1": shop1, "shop2": shop2, "shop3": shop3,
                                             "shop4": shop4, "mainList": mainList})
...
def mine(request):
    ...
    try:
        ...
        userimg = "/static/mdeia/" + username + ".png"
    except User.DoesNotExist as e:
        userrank = 0
        userimg = '/static/home/img/daohang1.png'
    print(userimg)
    return render(request, 'axf/mine.html', {"title": "我的", "username": username, "userrank": userrank,
                                             "userimg": userimg})
